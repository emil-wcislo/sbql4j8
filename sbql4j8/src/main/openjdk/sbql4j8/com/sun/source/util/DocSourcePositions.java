...
public interface DocSourcePositions extends SourcePositions {
     ...
     * return {@link sbql4j8.javax.tools.Diagnostic#NOPOS}.
     * The given tree should be under the given comment tree, and the given documentation
     * comment tree should be returned from a {@link DocTrees#getDocCommentTree(sbql4j8.com.sun.source.util.TreePath) }
