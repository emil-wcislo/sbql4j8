...
package sbql4j8.com.sun.source.util;
...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        ...
        if (!taskClassName.equals("sbql4j8.com.sun.tools.javac.api.JavacTaskImpl")
                && !taskClassName.equals("sbql4j8.com.sun.tools.javac.api.BasicJavacTask"))
    ...
    public static Trees instance(ProcessingEnvironment env) {
        if (!env.getClass().getName().equals("sbql4j8.com.sun.tools.javac.processing.JavacProcessingEnvironment"))
            throw new IllegalArgumentException();
    ...
    static Trees getJavacTrees(Class<?> argType, Object arg) {
        try {
            ...
            Class<?> c = Class.forName("sbql4j8.com.sun.tools.javac.api.JavacTrees", false, cl);
    ...
    /**
      ...
      * @return sbql4j8.javax.lang.model.type.TypeMirror corresponding to the original type, replaced by the ErrorType.
      */
