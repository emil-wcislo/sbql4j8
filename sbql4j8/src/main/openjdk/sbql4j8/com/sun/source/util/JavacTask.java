...
public abstract class JavacTask implements CompilationTask {
     ...
     * {@link sbql4j8.javax.tools.JavaCompiler.CompilationTask CompilationTask},
    ...
    public static JavacTask instance(ProcessingEnvironment processingEnvironment) {
        if (!processingEnvironment.getClass().getName().equals(
                "sbql4j8.com.sun.tools.javac.processing.JavacProcessingEnvironment"))
     ...
     * {@link sbql4j8.com.sun.source.util.Trees Trees}.
     * @see sbql4j8.com.sun.source.util.Trees#getTypeMirror
     */
