...
package sbql4j8.com.sun.tools.javac.file;
...
import sbql4j8.com.sun.tools.javac.file.RelativePath.RelativeDirectory;
...
public class ZipFileIndex {
     ...
     */
    public synchronized sbql4j8.com.sun.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            sbql4j8.com.sun.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return sbql4j8.com.sun.tools.javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public synchronized List<String> getDirectories(RelativeDirectory path) {
        try {
            ...
            DirectoryEntry de = directories.get(path);
            sbql4j8.com.sun.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private sbql4j8.com.sun.tools.javac.util.List<String> zipFileEntriesFiles = sbql4j8.com.sun.tools.javac.util.List.<String>nil();
        private sbql4j8.com.sun.tools.javac.util.List<String> zipFileEntriesDirectories = sbql4j8.com.sun.tools.javac.util.List.<String>nil();
        private sbql4j8.com.sun.tools.javac.util.List<Entry>  zipFileEntries = sbql4j8.com.sun.tools.javac.util.List.<Entry>nil();
        ...
        private sbql4j8.com.sun.tools.javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private sbql4j8.com.sun.tools.javac.util.List<String> getDirectories() {
        ...
        private sbql4j8.com.sun.tools.javac.util.List<Entry> getEntries() {
            if (!zipFileEntriesInited) {
                initEntries();
                zipFileEntries = sbql4j8.com.sun.tools.javac.util.List.nil();
