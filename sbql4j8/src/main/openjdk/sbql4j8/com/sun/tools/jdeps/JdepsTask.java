 ...
 * questions.
 */
package sbql4j8.com.sun.tools.jdeps;
...
import sbql4j8.com.sun.tools.classfile.Dependencies.ClassFileError;
import sbql4j8.com.sun.tools.classfile.Dependency;
import sbql4j8.com.sun.tools.jdeps.PlatformClassPath.JDKArchive;
import java.io.*;
...
class JdepsTask {
    ...
    private static class ResourceBundleHelper {
        ...
        static {
            ...
            try {
                bundle = ResourceBundle.getBundle("sbql4j8.com.sun.tools.jdeps.resources.jdeps", locale);
            } catch (MissingResourceException e) {
                throw new InternalError("Cannot find jdeps resource bundle for locale " + locale);
            }
            try {
                versionRB = ResourceBundle.getBundle("sbql4j8.com.sun.tools.jdeps.resources.version");
            } catch (MissingResourceException e) {
