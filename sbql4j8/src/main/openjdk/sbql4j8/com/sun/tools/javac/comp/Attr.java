...
import sbql4j8.com.sun.source.tree.TreeVisitor;
import sbql4j8.com.sun.source.util.SimpleTreeVisitor;
import sbql4j8.com.sun.tools.javac.code.*;
import sbql4j8.com.sun.tools.javac.code.Lint.LintCategory;
...
import static sbql4j8.com.sun.tools.javac.code.Flags.ANNOTATION;
...
import static sbql4j8.com.sun.tools.javac.code.TypeTag.WILDCARD;
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    private final class TypeAnnotationsValidator extends TreeScanner {
         ...
         * sbql4j8.com.sun.tools.javac.comp.Check.Validator.visitSelectInternal(JCFieldAccess)
