...
import static sbql4j8.com.sun.tools.javac.code.TypeTag.ARRAY;
...
public class TypeMaker {
    ...
    public static sbql4j8.com.sun.javadoc.Type getType(DocEnv env, Type t) {
     ...
     */
    public static sbql4j8.com.sun.javadoc.Type[] getTypes(DocEnv env, List<Type> ts) {
        return getTypes(env, ts, new sbql4j8.com.sun.javadoc.Type[ts.length()]);
    }
     ...
     */
    public static sbql4j8.com.sun.javadoc.Type[] getTypes(DocEnv env, List<Type> ts,
                                                  sbql4j8.com.sun.javadoc.Type res[]) {
        int i = 0;
        for (Type t : ts) {
            res[i++] = getType(env, t);
        }
    ...
    private static class ArrayTypeImpl implements sbql4j8.com.sun.javadoc.Type {
        ...
        private sbql4j8.com.sun.javadoc.Type skipArraysCache = null;

        public sbql4j8.com.sun.javadoc.Type getElementType() {
            return TypeMaker.getType(env, env.types.elemtype(arrayType));
        }

        private sbql4j8.com.sun.javadoc.Type skipArrays() {
