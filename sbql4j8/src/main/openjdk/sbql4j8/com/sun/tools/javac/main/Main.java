...
package sbql4j8.com.sun.tools.javac.main;
...
import sbql4j8.com.sun.tools.javac.code.Source;
import sbql4j8.com.sun.tools.javac.file.CacheFSInfo;
...
import sbql4j8.com.sun.tools.javac.util.Log.PrefixKind;
import sbql4j8.com.sun.tools.javac.util.Log.WriterKind;
import sbql4j8.com.sun.tools.javac.util.ServiceLoader;
import static sbql4j8.com.sun.tools.javac.main.Option.*;
...
public class Main {
    ...
    public Collection<File> processArgs(String[] flags, String[] classNames) { // XXX sb protected
        ...
        if (showClass != null) {
            if (showClass.equals("showClass")) // no value given for option
                showClass = "sbql4j8.com.sun.tools.javac.Main";
            showClass(showClass);
        }
                          ...
                          Iterable<? extends Processor> processors)
    {
        ...
        try {
            ...
            // as specified by sbql4j8.javax.tools.JavaCompiler#getTask
            // and sbql4j8.javax.tools.JavaCompiler.CompilationTask#call
            throw new RuntimeException(ex.getCause());
...
//    }
    ...
    public static final String javacBundleName =
        "sbql4j8.com.sun.tools.javac.resources.javac";
//
