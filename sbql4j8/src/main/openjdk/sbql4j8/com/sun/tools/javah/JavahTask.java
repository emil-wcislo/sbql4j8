...
package sbql4j8.com.sun.tools.javah;
...
import sbql4j8.com.sun.tools.javac.main.CommandLine;
...
//                throw new BadArgs("jni.no.stubs");
    ...
    private static final String versionRBName = "sbql4j8.com.sun.tools.javah.resources.version";
    ...
    private String getMessage(Locale locale, String key, Object... args) {
        ...
        if (b == null) {
            try {
                b = ResourceBundle.getBundle("sbql4j8.com.sun.tools.javah.resources.l10n", locale);
