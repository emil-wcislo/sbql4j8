...
import sbql4j8.com.sun.tools.sjavac.Util;
import sbql4j8.com.sun.tools.sjavac.ProblemException;
import java.io.*;
import java.util.*;
...
public class JavacServer {
    ...
    public static int useServer(String settings, String[] args,
        ...
        try {
            ...
            // to point to a sbql4j8.com.sun.tools.sjavac.Main that supports --startserver
            // for example by setting: sjavac=java%20-jar%20...javac.jar%sbql4j8.com.sun.tools.sjavac.Main
