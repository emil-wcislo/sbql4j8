...
*/
// Code duplicated in sbql4j8.com.sun.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // In sbql4j8.com.sun.tools.javac.jvm.Gen.genCatch we first set the type_index
    // to the catch type index - that value is only temporary.
    // Then in sbql4j8.com.sun.tools.javac.jvm.Code.fillExceptionParameterPositions
