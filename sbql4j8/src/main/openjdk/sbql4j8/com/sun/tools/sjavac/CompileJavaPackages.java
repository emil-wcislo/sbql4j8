...
import sbql4j8.com.sun.tools.sjavac.server.SysInfo;
...
public class CompileJavaPackages implements Transformer {
                             ...
                             PrintStream err)
    {
        ...
        // More than three concurrent cores does not currently give a speedup, at least for compiling the sbql4j8.jdk
