...
import sbql4j8.com.sun.tools.javac.code.Symbol.PackageSymbol;
import sbql4j8.com.sun.tools.javac.code.Symbol.TypeSymbol;
import sbql4j8.com.sun.tools.javac.code.Symbol.VarSymbol;
import sbql4j8.com.sun.tools.javac.code.Type;
import sbql4j8.com.sun.tools.javac.code.Type.ArrayType;
import sbql4j8.com.sun.tools.javac.code.Type.ClassType;
import sbql4j8.com.sun.tools.javac.code.Type.ErrorType;
import sbql4j8.com.sun.tools.javac.code.Type.UnionClassType;
import sbql4j8.com.sun.tools.javac.code.Types;
import sbql4j8.com.sun.tools.javac.code.Types.TypeRelation;
import sbql4j8.com.sun.tools.javac.comp.Attr;
import sbql4j8.com.sun.tools.javac.comp.AttrContext;
import sbql4j8.com.sun.tools.javac.comp.Enter;
import sbql4j8.com.sun.tools.javac.comp.Env;
import sbql4j8.com.sun.tools.javac.comp.MemberEnter;
import sbql4j8.com.sun.tools.javac.comp.Resolve;
...
import sbql4j8.com.sun.tools.javac.tree.DCTree.DCBlockTag;
import sbql4j8.com.sun.tools.javac.tree.DCTree.DCDocComment;
import sbql4j8.com.sun.tools.javac.tree.DCTree.DCEndPosTree;
import sbql4j8.com.sun.tools.javac.tree.DCTree.DCErroneous;
import sbql4j8.com.sun.tools.javac.tree.DCTree.DCIdentifier;
import sbql4j8.com.sun.tools.javac.tree.DCTree.DCParam;
import sbql4j8.com.sun.tools.javac.tree.DCTree.DCReference;
import sbql4j8.com.sun.tools.javac.tree.DCTree.DCText;
import sbql4j8.com.sun.tools.javac.tree.EndPosTable;
import sbql4j8.com.sun.tools.javac.tree.JCTree;
import sbql4j8.com.sun.tools.javac.tree.JCTree.*;
import sbql4j8.com.sun.tools.javac.tree.TreeCopier;
import sbql4j8.com.sun.tools.javac.tree.TreeInfo;
import sbql4j8.com.sun.tools.javac.tree.TreeMaker;
import sbql4j8.com.sun.tools.javac.util.Abort;
...
public class JavacTrees extends DocTrees {
    ...
    private VarSymbol searchField(ClassSymbol tsym, Name fieldName, Set<ClassSymbol> searched) {
        ...
        for (sbql4j8.com.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(fieldName);
    ...
    /** @see sbql4j8.com.sun.tools.javadoc.ClassDocImpl#findConstructor */
    MethodSymbol findConstructor(ClassSymbol tsym, List<Type> paramTypes) {
        for (sbql4j8.com.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(names.init);
                e.scope != null; e = e.next()) {
    ...
    /** @see sbql4j8.com.sun.tools.javadoc.ClassDocImpl#findMethod */
    ...
    /** @see sbql4j8.com.sun.tools.javadoc.ClassDocImpl#searchMethod */
    private MethodSymbol searchMethod(ClassSymbol tsym, Name methodName,
        ...
        sbql4j8.com.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(methodName);
    ...
    /** @see sbql4j8.com.sun.tools.javadoc.ClassDocImpl */
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof sbql4j8.com.sun.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (sbql4j8.com.sun.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
    ...
    public TypeMirror getOriginalType(javax.lang.model.type.ErrorType errorType) {
        if (errorType instanceof sbql4j8.com.sun.tools.javac.code.Type.ErrorType) {
            return ((sbql4j8.com.sun.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }

        return sbql4j8.com.sun.tools.javac.code.Type.noType;
    }
    ...
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            sbql4j8.com.sun.source.tree.Tree t,
            sbql4j8.com.sun.source.tree.CompilationUnitTree root) {
        printMessage(kind, msg, ((JCTree) t).pos(), root);
    }

    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            sbql4j8.com.sun.source.doctree.DocTree t,
            sbql4j8.com.sun.source.doctree.DocCommentTree c,
            sbql4j8.com.sun.source.tree.CompilationUnitTree root) {
