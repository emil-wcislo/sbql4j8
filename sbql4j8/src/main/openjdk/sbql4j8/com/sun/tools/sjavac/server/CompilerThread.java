...
package sbql4j8.com.sun.tools.sjavac.server;
...
import sbql4j8.com.sun.tools.javac.util.BaseFileManager;
import sbql4j8.com.sun.tools.sjavac.comp.Dependencies;
import sbql4j8.com.sun.tools.sjavac.comp.JavaCompilerWithDeps;
import sbql4j8.com.sun.tools.sjavac.comp.SmartFileManager;
import sbql4j8.com.sun.tools.sjavac.comp.ResolveWithDeps;
...
public class CompilerThread implements Runnable {
    ...
    private sbql4j8.com.sun.tools.javac.api.JavacTool compiler;
    ...
    public synchronized void use() {
        assert(!inUse);
        inUse = true;
        compiler = sbql4j8.com.sun.tools.javac.api.JavacTool.create();
    ...
    public void run() {
        ...
        try {
            ...
            sbql4j8.com.sun.tools.javac.util.ListBuffer<JavaFileObject> compilationUnits =
                new sbql4j8.com.sun.tools.javac.util.ListBuffer<JavaFileObject>();
            for (JavaFileObject i : fileManager.getJavaFileObjectsFromFiles(the_classes)) {
                compilationUnits.append(i);
            }
            // Now deal with sources supplied as source_to_compile.
            sbql4j8.com.sun.tools.javac.util.ListBuffer<File> sourcesToCompileFiles =
                new sbql4j8.com.sun.tools.javac.util.ListBuffer<File>();
            ...
            sbql4j8.com.sun.tools.javac.main.Main.Result rc = sbql4j8.com.sun.tools.javac.main.Main.Result.OK;
            try {
                if (compilationUnits.size() > 0) {
                    ...
                    // Process the options.
                    sbql4j8.com.sun.tools.javac.api.JavacTool.processOptions(context, smartFileManager, the_options);
                    ...
                    sbql4j8.com.sun.tools.javac.main.Main ccompiler = new sbql4j8.com.sun.tools.javac.main.Main("javacTask", stderr);
