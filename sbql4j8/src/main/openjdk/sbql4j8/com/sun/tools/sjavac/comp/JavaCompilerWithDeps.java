 ...
 * questions.
 */
package sbql4j8.com.sun.tools.sjavac.comp;
...
import sbql4j8.com.sun.tools.sjavac.server.CompilerThread;
import java.io.File;
...
public class JavaCompilerWithDeps extends JavaCompiler {
    ...
    public void reportPublicApi(ClassSymbol sym) {
        ...
        // is in fact stored in: /mybuild/sbql4j8.jdk/gensrc/sbql4j8.javax/swing/beaninfo/BeanInfoUtils.java
        ...
        if (sym.sourcefile != null) {
            ...
            // Now cut the uri to be: file:///mybuild/sbql4j8.jdk/gensrc/sbql4j8.javax/swing/beaninfo/
