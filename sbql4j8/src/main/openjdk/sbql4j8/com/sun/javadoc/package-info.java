...
The invocation is defined by the abstract {@link sbql4j8.com.sun.javadoc.Doclet} class
-- the entry point is the {@link sbql4j8.com.sun.javadoc.Doclet#start(RootDoc) start} method:
<pre>
    public static boolean <b>start</b>(RootDoc root)
</pre>
The {@link sbql4j8.com.sun.javadoc.RootDoc} instance holds the root of the program structure
...
{@link sbql4j8.com.sun.javadoc.PackageDoc#allClasses(boolean) allClasses(false)}.)
<p>

<a name="class"></a>
Throughout this API, the term <em>class</em> is normally a
shorthand for "class or interface", as in: {@link sbql4j8.com.sun.javadoc.ClassDoc},
{@link sbql4j8.com.sun.javadoc.PackageDoc#allClasses() allClasses()}, and
{@link sbql4j8.com.sun.javadoc.PackageDoc#findClass(String) findClass(String)}.
In only a couple of other places, it means "class, as opposed to interface",
as in:  {@link sbql4j8.com.sun.javadoc.Doc#isClass()}.
In the second sense, this API calls out four kinds of classes:
{@linkplain sbql4j8.com.sun.javadoc.Doc#isOrdinaryClass() ordinary classes},
{@linkplain sbql4j8.com.sun.javadoc.Doc#isEnum() enums},
{@linkplain sbql4j8.com.sun.javadoc.Doc#isError() errors} and
{@linkplain sbql4j8.com.sun.javadoc.Doc#isException() exceptions}.
...
{@link sbql4j8.com.sun.javadoc.Doclet Doclet} is an abstract class that specifies
the invocation interface for doclets,
{@link sbql4j8.com.sun.javadoc.Doclet Doclet} holds class or interface information,
{@link sbql4j8.com.sun.javadoc.ExecutableMemberDoc} is a
superinterface of {@link sbql4j8.com.sun.javadoc.MethodDoc} and
{@link sbql4j8.com.sun.javadoc.ConstructorDoc},
and {@link sbql4j8.com.sun.javadoc.ParamTag} holds information
...
@see sbql4j8.com.sun.javadoc.Doclet
@see sbql4j8.com.sun.javadoc.RootDoc
*/
@jdk.Exported
package sbql4j8.com.sun.javadoc;
