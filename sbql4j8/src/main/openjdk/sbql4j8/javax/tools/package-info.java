 ...
 * ({@linkplain sbql4j8.javax.tools.DiagnosticListener}) as well as a file
 * abstraction for overriding file access ({@linkplain
 * sbql4j8.javax.tools.JavaFileManager} and {@linkplain
 * sbql4j8.javax.tools.JavaFileObject}).  See {@linkplain
 * sbql4j8.javax.tools.JavaCompiler} for more details on using the SPI.
 *
 * <p>There is no requirement for a compiler at runtime.  However, if
 * a default compiler is provided, it can be located using the
 * {@linkplain sbql4j8.javax.tools.ToolProvider}, for example:
 *
 ...
 * META-INF/services/sbql4j8.javax.tools.JavaCompiler}.  This file would
